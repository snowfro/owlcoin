...
uint256 hashGenesisBlock("0x9513d7c91ff8e4d7eb2d6461abb57ba5f785cbd997776804b5fceb30757394d1");
...
const string strMessageMagic = "OwlCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // OwlCoin: 1 days
static const int64 nTargetSpacing = 60; // OwlCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal owlcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OwlCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7a5852650dd932371b41a6717f42f6bfb0c6aef12f98bd85a4dcdff7b662c37f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1511801056; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 208179;

        if (fTestNet)
        {
            block.nTime    = 1511799012;
            block.nNonce   = 12991;
        }
